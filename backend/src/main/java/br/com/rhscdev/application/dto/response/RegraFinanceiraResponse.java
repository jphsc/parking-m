...
public class RegraFinanceiraResponse implements BaseIdentificavel, Serializable {
	...
	public RegraFinanceiraResponse() {
	...
	public RegraFinanceiraResponse(Builder build) {
		this.id = build.id;
	...
	public static class Builder {
		...
		public RegraFinanceiraResponse build() {
			return new RegraFinanceiraResponse(this);
		}
