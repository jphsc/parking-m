...
public class RegraFinanceiraResource {
	...
	public Response cadastrarRegraFinanceira(@RequestBody @Valid @ConvertGroup(from = Default.class, to = OnCreate.class) RegraFinanceiraRequest request) {
	...
	public Response atualizarRegraFinanceira(@RequestBody @Valid @ConvertGroup(from = Default.class, to = OnUpdate.class) RegraFinanceiraRequest request) {
