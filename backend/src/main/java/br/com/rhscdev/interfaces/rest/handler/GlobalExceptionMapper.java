...
public class GlobalExceptionMapper implements ExceptionMapper<Throwable> {
	...
	public Response toResponse(Throwable exception) {
        ...
        if (exception instanceof GlobalException globalEx) {
            ...
            codigoErro = Constantes.COD_INEXISTENTE;
            ...
            codigoErro = Constantes.COD_VALIDACAO_METHOD;
            ...
            codigoErro = Constantes.COD_VALIDACAO_REGISTRO;
        ...
        erroResponse = new ErroResponse(codigoErro, mensagem);
	...
	private Status mapGlobalExceptionStatus(Integer codigoErro) {
        switch (codigoErro) {
            case Constantes.COD_INEXISTENTE:
                return Status.NOT_FOUND;

            case Constantes.COD_VALIDACAO_REGISTRO:
                return Status.BAD_REQUEST;
                
            case Constantes.COD_VALIDACAO_METHOD:
