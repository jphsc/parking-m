...
public class VeiculoResource {
	...
	public Response cadastrarVeiculo(@RequestBody @Valid @ConvertGroup(from = Default.class, to = OnCreate.class) VeiculoRequest veiculo) {
	...
	public Response atualizarVeiculo(@RequestBody @Valid @ConvertGroup(from = Default.class, to = OnUpdate.class) VeiculoRequest filtro) {
