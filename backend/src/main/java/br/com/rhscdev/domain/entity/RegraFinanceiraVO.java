...
public class RegraFinanceiraVO extends BaseVO implements Comparable<RegraFinanceiraVO> {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "regra_financeira_seq")
	@SequenceGenerator(name = "regra_financeira_seq", sequenceName = "tb_regra_financeira_ref_id_seq", allocationSize = 1)
	@Column(name = "ref_id")
	private Integer id;
	
	@Column(name = "ref_descricao", nullable = false, length = 50)
	...
	protected RegraFinanceiraVO(Integer id, String descricao, BigDecimal valor, Integer tipoCobranca, Integer tipoMovimento,
	...
	protected RegraFinanceiraVO(String descricao, BigDecimal valor, Integer tipoCobranca, Integer tipoMovimento,
			LocalDate dtInicioValidade, LocalDate dtFimValidade, Integer situacao) {
		this.descricao = descricao;
		this.valor = valor;
		this.tipoCobranca = tipoCobranca;
	...
	public static RegraFinanceiraVO criar(String descricao, BigDecimal valor, Integer tipoCobranca, Integer tipoMovimento,
			LocalDate dtInicioValidade, LocalDate dtFimValidade, Integer situacao) {
		
		return new RegraFinanceiraVO(descricao, valor, tipoCobranca, tipoMovimento, dtInicioValidade, dtFimValidade, situacao);
	}
	
	public void atualizar(Integer id, String descricao, BigDecimal valor, Integer tipoCobranca, Integer tipoMovimento,
			LocalDate dtInicioValidade, LocalDate dtFimValidade, Integer situacao) {
