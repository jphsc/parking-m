...
public abstract class Constantes {
	...
	public static final String MSG_ERRO_ID = "O identificador do registro não foi informado ou é inválido, informe um id válido para realizar a operação desejada.";
	public static final String MSG_ERRO_NULL = "Há campos obrigatórios que não foram informados.";
